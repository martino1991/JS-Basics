...
function histogram(inputAera) {
    ...
    for (i = 1; i <= inputNumber; i += 1) {
        if (inputAera[i] < 200) {
            p1 += 1;
        } else if (inputAera[i] <= 399) {
            p2 += 1;
        } else if (inputAera[i] <= 599) {
            p3 += 1;
        } else if (inputAera[i] <= 799) {
            p4 += 1;
        } else {
            p5 += 1;
        }
    ...
    console.log(`${((p1 / inputNumber) * 100).toFixed(2)}%`);
    console.log(`${((p2 / inputNumber) * 100).toFixed(2)}%`);
    console.log(`${((p3 / inputNumber) * 100).toFixed(2)}%`);
    console.log(`${((p4 / inputNumber) * 100).toFixed(2)}%`);
    console.log(`${((p5 / inputNumber) * 100).toFixed(2)}%`);
